...
file = open("/Users/peggy/Documents/109-2(2-2)/machine_learning/MLGame/games/pingpong/log/HARD_1.pickle","rb")
...
for i in range (2,2):
	path = "/Users/peggy/Documents/109-2(2-2)/machine_learning/MLGame/games/pingpong/log/HARD_("+str(i)+").pickle"
	file = open(path,"rb")
	data = pickle.load(file)
